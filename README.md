...
Обучение проводилось на датасетах, скачанных с MosMedData:
...
В класс патологии были объединены COVID-19 и рак легкого.

Результаты обучения модели бинарной классификации приведены в [plots/training_results.txt](https://github.com/evgenyevih/Service4CT/blob/main/plots/training_results.txt)

Параметры обучения приведены в [configs/config.yaml](https://github.com/evgenyevih/Service4CT/blob/main/configs/config.yaml)
